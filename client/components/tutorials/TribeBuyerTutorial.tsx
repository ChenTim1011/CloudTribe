  ...
  const tutorialSteps = [
    {
      ...
      image: "/tribeBuyerTutorial/1.png"
    },
    {
      title: "2. 我的訂單",
      description: "• 查看目前訂單的狀態和價格\n• 查看訂單詳細的明細\n• 查看訂單的配送狀態",
      image: "/tribeBuyerTutorial/2.png"
    },
    {
      title: "3. 新增想要購買的商品",
      description: "• 當想要商品搜尋不到可以使用\n• 輸入詳細的商品資訊、數量、價格\n• 地點可以搜尋讓司機知道該商品可以去哪裡購買",
      image: "/tribeBuyerTutorial/3.png"
    },
    {
      title: "4. 搜尋想要的商品種類",
      description: "• 先挑選大種類之後有個別細項\n• 或是透過搜尋找到想要的商品種類\n• 透過篩選找到符合需求的商品",
      image: "/tribeBuyerTutorial/4.png"
    },
    {
      title: "5. 商品分類瀏覽",
      description: "• 選擇商品分類\n• 瀏覽分類商品\n• 快速找到需要商品",
      image: "/tribeBuyerTutorial/5.png"
    },
    {
      title: "6. 商品名稱和價格",
      description: "• 可輸入自己想要購買的數量\n• 按下加入購物車就可以把商品放入購物車\n• 商品連結才能知道目前真正的商品價格以及是否有貨",
      image: "/tribeBuyerTutorial/6.png"
    },
    {
      title: "7. 點選商品連結",
      description: "• 可以到家樂福官網看目前商品的售價\n• 可以查看的商品資訊\n• 可以看到商品的評價",
      image: "/tribeBuyerTutorial/7.png"
    },
    {
      title: "8. 購物車結帳",
      description: "• 可以調整購買數量\n• 查看購物車品項以及總金額\n• 確認沒問題就可以點選結帳",
      image: "/tribeBuyerTutorial/8.png"
    },
    {
      title: "9. 完成訂購",
      description: "• 填寫基本資料後\n• 如果比較急件可以勾是否緊急\n• 提交訂單等待出貨通知",
    ...
    {
      title: "10. 司機接單通知訊息",
      description: "• 當司機接單會有訊息通知買家",
      image: "/tribeBuyerTutorial/10.png"
    }
  ];
